<template>
  <!-- ##### Welcome Area Start ##### -->
<section class="welcome_area bg-img background-overlay" style="background-image: url(assets/img/bg-img/imagehome.jpg);">
        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                <div class="hero-content">
                    ...
                    <a href="#" class="btn essence-btn" style="border-radius:10px">CHƠI NGAY</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="cta-area">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="cta-content bg-img background-overlay" style="background-image: url(assets/img/bg-img/khung2.png);">
                    <video controls style="width:89.5%;border-radius:10px;height:96%;padding-top:80px">
                        <source src="assets/img/video/azirvideo_Trim.mp4">
                    </video>
                </div>
            </div>
        </div>
                ...
                <div class="popular-products-slides owl-carousel">
                    ...
                    <div class="single-product-wrapper">
                        ...
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh4.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                                <h6>Nguyễn Vũ Quân</h6>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh1.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh2.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh3.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh5.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                                <h6>Trần Quốc Việt (Việt Xích Lô)</h6>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh6.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
                                <h6>Nguyễn Hoàng Lâm</h6>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="single-product-wrapper">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="assets/img/product-img/hinh7.jpg" alt="">
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <a href="#">
